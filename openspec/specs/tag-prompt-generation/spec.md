...
Generates a self-contained LLM prompt from plan analysis data that produces JSON compatible with `crate apply-tags`. Keeps the CLI LLM-free while streamlining the tag classification workflow.
