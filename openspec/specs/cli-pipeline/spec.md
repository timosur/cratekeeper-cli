...
Defines how CLI command handlers delegate to domain functions, ensuring thin handlers with no inline business logic and a wizard that reuses CLI handlers via context invoke.
