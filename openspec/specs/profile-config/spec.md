...
Manages named DJ profiles in a TOML config file, allowing different genre bucket sets, tag formats, library targets, and admission criteria per workflow (e.g. commercial vs. electronic).
